...
function Moviecard({ movie }) {
    ...
    return (
      <motion.div
        ...
        exit={{ opacity: 1 }}
        layout
        className="card relative w-full md:w-60 h-[410px] md:h-[360px] my-3 mx-4 md:my-5 md:mx-0 cursor-pointer rounded-xl overflow-hidden hover:scale-x-115 duration-300"
      >
        {/* bookmark buttons */}
        <button
        ...
        >
          {" "}
          {isBookmarked ? <AiFillHeart className='text-red-700' /> : <AiOutlineHeart />}
        </button>
